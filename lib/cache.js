(function() {
  ...
  ConnectFileCache = (function() {
    ...
    ConnectFileCache.prototype.serveBuffer = function(req, res, next, _arg) {
      var cacheTimestamp, clientTimestamp, contentDisposition, data, filename, flags, route, _ref, _ref2;
      route = _arg.route;
      _ref = _.defaults(this.map[route], {
        flags: {}
      }), data = _ref.data, flags = _ref.flags, cacheTimestamp = _ref.mtime;
