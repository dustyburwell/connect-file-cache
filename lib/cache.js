(function() {
  var ConnectFileCache, FAR_FUTURE_EXPIRES, MIN_GZIP_SIZE, fs, gzip, gzipcompress, mime, normalizeRoute, parse, path, _;
    ...
    ConnectFileCache.prototype.set = function(routes, data, flags) {
      ...
      for (_i = 0, _len = routes.length; _i < _len; _i++) {
        ...
        if (data.length >= MIN_GZIP_SIZE) {
          this.map[normalizeRoute(route)].gzippedData = gzip(data);
        }
      }
      return this;
    };
