(function() {
  var ConnectFileCache, FAR_FUTURE_EXPIRES, fs, gzip, gzipcompress, mime, normalizeRoute, parse, path, _;
  ...
  gzipcompress = require('zlib-sync').gzipcompress;
  ...
  ConnectFileCache = (function() {
    ...
    ConnectFileCache.prototype.serveBuffer = function(req, res, next, _arg) {
      ...
      if ((_ref2 = req.headers['accept-encoding']) != null ? _ref2.indexOf(/gzip/) : void 0) {
    ...
    ConnectFileCache.prototype.set = function(routes, data, flags) {
      var gzippedData, mtime, route, _i, _len, _ref;
      if (flags == null) {
        flags = {};
      }
      ...
      gzippedData = gzip(data);
      mtime = (_ref = flags.mtime) != null ? _ref : new Date();
